    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50">
      ...
      <header className="bg-white shadow-md">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center">
            <img
              src="https://i.ibb.co/Y2Kc8Th/Untitled-design-4.png"
              alt="FarmFlow Logo"
              className="h-10 w-auto mr-4"
            />
            <h1 className="text-2xl font-bold text-green-600">FarmFlow</h1>
          </div>
          <nav>
            <Link
              to="/login"
              className="text-gray-600 hover:text-green-600 mx-4">
              Login
            </Link>
            <Link
              to="/signup"
      ...
      <section className="container mx-auto px-6 py-16 text-center">
        <h2 className="text-5xl font-extrabold mb-4 text-gray-800">
          Smart Farming for a{" "}
          <span className="text-green-600">Brighter Future</span>
        </h2>
        <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
          Empower your farm with cutting-edge technology and data-driven
          insights. This estimation tool helps you maximize yields, reduce
          costs, and cultivate sustainability.
        </p>
        <Link
          to="/signup"
      ...
      <section className="py-16 bg-green-600 text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <blockquote className="text-2xl italic mb-8">
            "FarmFlow has revolutionized the way I manage my farm. I've seen a
            30% increase in yields and significant cost savings."
          </blockquote>
      ...
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Join thousands of farmers already using FarmFlow to grow smarter.
          </p>
          <Link
            to="/signup"
            className="bg-green-500 hover:bg-green-600 text-white font-bold py-3 px-8 rounded-full text-lg transition duration-300 inline-block">
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-wrap justify-between">
            <div className="w-full md:w-1/4 mb-6 md:mb-0">
              <h3 className="text-lg font-semibold mb-2">FarmFlow</h3>
              <p className="text-gray-400">
                Empowering farmers with smart solutions for a bountiful harvest
              </p>
            </div>
            <div className="w-full md:w-1/4 mb-6 md:mb-0">
          ...
          <div className="border-t border-gray-700 mt-8 pt-8 text-sm text-gray-400 text-center">
            <p>&copy; 2024 FarmFlow. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
